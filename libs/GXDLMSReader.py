...
from gurux_dlms import GXReplyData, GXDLMSTranslator, GXDLMSException, GXDLMSAccessItem, \
     GXDate
...
from gurux_dlms.objects import GXDLMSObject, GXDLMSObjectCollection, GXDLMSData, GXDLMSRegister, \
    ...
    GXDLMSWeekProfile, GXDLMSSeasonProfile, \
    GXDLMSScriptTable, GXDLMSSpecialDaysTable, GXDLMSActivityCalendar, GXDLMSDayProfile, GXDLMSDayProfileAction
...
class GXDLMSReader(GXDLMSDisconnectControl):
    ...
    def add_season_profile(self, calendar, season_count, start_time=None):
        ...
        if not start_time:
            # Starts time seasons
            start_time = ["01.01.* 00:00:00", "05.01.* 00:00:00",
                          "06.01.* 00:00:00", "10.01.* 00:00:00"]
