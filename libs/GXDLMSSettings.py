...
from gurux_dlms.enums import Conformance, Priority, ServiceClass, InterfaceType, Authentication, Standard, \
    DateTimeSkips, HdlcFrameType
    ...
    def checkFrame(self, frame_, xml):
        ...
        if (self.senderFrame & 0x1) == 0:
            ...
            if self.hdlc.windowSizeRX != 1:
                ...
                expected = self.increaseReceiverSequence(self.increaseSendSequence(self.receiverFrame))
                if frame_ == expected:
                    ReceiverFrame = frame_
                    return True
